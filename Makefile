...
LIBRARY_NAME = beat_detection

# add your .c source files, one object per file, to the SOURCES
# variable, help files will be included automatically, and for GUI
# objects, the matching .tcl file too
SOURCES = beat_detection.cpp

# list all pd objects (i.e. myobject.pd) files here, and their helpfiles will
# be included automatically
PDOBJECTS = beat_detection.pd
...
ALL_CFLAGS = -I"$(PD_INCLUDE)" -I"../utils"
ALL_LDFLAGS =  
SHARED_LDFLAGS =
ALL_LIBS = 
...
../BeatHistogram/BeatHistogram.o: ../BeatHistogram/BeatHistogram.cpp
	$(CC) $(ALL_CFLAGS) -o "../BeatHistogram/BeatHistogram.o" -c "../BeatHistogram/BeatHistogram.cpp"

%.o: %.c
	$(CC) $(ALL_CFLAGS) -o "$*.o" -c "$*.c"

%.$(EXTENSION): ../BeatHistogram/BeatHistogram.o %.o $(SHARED_LIB)
	$(CC) $(ALL_LDFLAGS) -o "$*.$(EXTENSION)" "../BeatHistogram/BeatHistogram.o" "$*.o"  $(ALL_LIBS) $(SHARED_LIB)
	chmod a-x "$*.$(EXTENSION)"
